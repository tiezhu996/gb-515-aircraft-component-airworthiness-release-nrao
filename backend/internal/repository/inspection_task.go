...
type InspectionTaskRepository interface {
	...
	FindLatestByRelatedCode(context.Context, string) (model.InspectionTask, error)
...
func (r *inspectionTaskRepository) FindLatestByRelatedCode(ctx context.Context, relatedCode string) (model.InspectionTask, error) {
