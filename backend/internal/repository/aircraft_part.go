...
type AircraftPartRepository interface {
	...
	GetByCode(context.Context, string) (model.AircraftPart, error)
...
func (r *aircraftPartRepository) GetByCode(ctx context.Context, code string) (model.AircraftPart, error) {
